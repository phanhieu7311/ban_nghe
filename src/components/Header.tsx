          ...
          <form onSubmit={handleSearch} className="w-64 lg:w-80">
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-10 pr-4 py-2.5 border border-[var(--color-border)] rounded-full focus:ring-2 focus:ring-[var(--color-primary)] focus:border-transparent outline-none transition-all text-sm"
              />
            </div>
          </form>
